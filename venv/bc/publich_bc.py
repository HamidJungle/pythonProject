...
def publish_to_ASW():
    ...
    PATH_TO_CERT = "certificates/7d271fd0c5-certificate.pem.crt"
    PATH_TO_KEY = "certificates/7d271fd0c5-private.pem.key"
    ...
    print("Published: '" + message + "' to the topic: " + "'topic1'")
    t.sleep(0.1)
    print('Publish End')
